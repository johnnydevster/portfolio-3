...
export default function PlanetOne() {
  ...
  return (
    <motion.div
      style={{ scale: 1 + scrollYProgress.current * 10000 }}
      animate={{ height: 600, width: 600 }}
    >
      <svg viewBox="613.01 536.447 180.038 137.518">
        <defs>
          ...
          >
            <stop offset="0" stop-color="#8cbdb7"></stop>
            <stop offset="1" stop-color="#1f768f"></stop>
          </radialGradient>
          <radialGradient
          ...
          >
            <stop offset="0.29" stop-color="aqua"></stop>
